...
class TextFieldWidgetSettings extends StatefulWidget {
  final String hint;
  ...
  @override
  State<TextFieldWidgetSettings> createState() => _TextFieldWidgetState();
}

class _TextFieldWidgetState extends State<TextFieldWidgetSettings> {
  void _viewPass() {
    setState(() {
